  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(to right bottom, rgba(255,255,255,0.05), rgba(255,255,255,0.05)), url(${bgImage})`,
        }}
      >
        <div className="absolute inset-0 bg-gradient-to-b from-black/50 via-transparent to-white/20"></div>{" "}
        {/* Reduced white fade, slightly darker top for contrast */}
        <div className="container relative px-4 mx-auto text-center z-10">
          ...
          <p className="max-w-xl mx-auto mb-10 text-xl text-white font-medium md:text-2xl drop-shadow-md bg-black/30 backdrop-blur-[4px] rounded-full py-2 px-6 border border-white/20 inline-block">
            Special goodies for you foodies. Experience the true taste of
            tradition.
          </p>
        ...
        <div className="container px-4 mx-auto max-w-7xl relative">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-gray-500 max-w-2xl mx-auto">
              We don't just serve food; we serve memories with a side of joy.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            {features.map((feature, index) => (
              <div
                key={index}
                className="group p-8 text-center transition-all bg-white border border-gray-100 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-2"
              >
                <div
                  ...
                  }-200 transition-transform group-hover:scale-110 group-hover:rotate-3`}
                >
                  {feature.icon}
                </div>
        ...
        <div className="container px-4 mx-auto max-w-6xl">
          <div className="flex flex-col gap-12 lg:flex-row">
            ...
            <div className="flex-1 space-y-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-8 border-l-8 border-[#e93b92] pl-6">
                Find Us
              </h2>
              ...
              {[
                {
                  title: "Restaurant",
                  address: "2/1, Alauddin tower, East Rampura, DIT Road",
                  bg: "bg-pink-50",
                ...
                {
                  title: "Cafe",
                  address: "257 West Rampura, DIT Road",
                  bg: "bg-purple-50",
                ...
                {
                  title: "Express",
                  address: "25/B 3rd Floor, MANAMA MW Heights",
                  bg: "bg-orange-50",
                ...
                <div
                  key={idx}
                  className={`flex items-start gap-4 p-5 rounded-xl border ${loc.borderColor} ${loc.bg} hover:shadow-md transition-shadow`}
                >
                  <div className={`mt-1 text-2xl ${loc.iconColor}`}>
                    <HiOutlineLocationMarker />
                  </div>
                  <div>
            ...
            <div className="flex-1 space-y-8 lg:pl-12 lg:border-l-2 border-dashed border-gray-200">
              <h2 className="text-3xl font-bold text-gray-900 mb-8 border-l-8 border-[#FFC107] pl-6">
                Opening Hours
              </h2>
              ...
              <div className="flex gap-6 items-center p-8 bg-white rounded-2xl border border-yellow-100 shadow-[0_4px_20px_rgb(255,193,7,0.1)] hover:-translate-y-1 transition-transform">
                <div className="p-4 bg-yellow-100 text-[#FFC107] rounded-full text-3xl">
                  <HiClock />
                </div>
                <div>
              ...
              <div className="flex gap-6 items-center p-8 bg-white rounded-2xl border border-teal-100 shadow-[0_4px_20px_rgb(0,176,155,0.1)] hover:-translate-y-1 transition-transform">
                <div className="p-4 bg-teal-100 text-[#00b09b] rounded-full text-3xl">
                  <HiPhone />
                </div>
                <div>
      ...
      >
        ...
        <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-[#AC5180] via-[#FFC107] to-[#160121]"></div>

        <div className="container px-4 mx-auto max-w-7xl relative z-10">
          {/* Section Header */}
          <div className="text-center mb-16">
            <span className="inline-block px-4 py-1 mb-4 text-sm font-bold tracking-widest text-white uppercase bg-gradient-to-r from-[#AC5180] to-[#160121] rounded-full shadow-lg">
              Book A Table
            </span>
            <h2 className="text-5xl md:text-6xl font-extrabold mb-6 font-['Italianno'] text-transparent bg-clip-text bg-gradient-to-r from-[#AC5180] to-[#160121] py-2">
              Reserve Your Table
            </h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto mb-8">
              Secure your spot for an unforgettable dining experience. Whether
              it's a romantic dinner or a family gathering, we have the perfect
              table for you.
            </p>

            <div className="flex flex-wrap justify-center gap-6">
              <div className="flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-sm border border-pink-100">
                <FaCheckCircle className="text-[#e93b92] text-xl" />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border-t-4 border-[#AC5180]">
              <div className="p-8 md:p-12">
                <div className="flex items-center justify-center gap-3 mb-8 text-2xl font-bold text-gray-800 border-b border-gray-100 pb-4">
                  <FaUtensils className="text-[#AC5180]" />
                  <span>Dining with Friends & Family</span>
                </div>
        ...
        <div className="absolute bottom-0 left-0 w-full h-[1px] bg-gradient-to-r from-[#AC5180] via-[#FFC107] to-[#160121]"></div>
      </section>
      ...
      <section className="py-28 text-center relative overflow-hidden bg-gradient-to-br from-[#e93b92] to-purple-700">
        ...
        <div className="container relative px-4 mx-auto max-w-4xl">
          <h2 className="mb-6 text-4xl font-bold text-white md:text-6xl drop-shadow-sm font-['Poppins']">
            Ready to Taste the Magic?
          </h2>
          <p className="mb-10 text-xl text-pink-100 max-w-2xl mx-auto">
            Join thousands of happy foodies experiencing the authentic taste of
            Bengal. Order online or book your table today.
          </p>
