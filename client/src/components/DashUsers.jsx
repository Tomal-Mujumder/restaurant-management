    ...
    <div className="p-3 overflow-x-scroll">
      <div className="flex items-center justify-between mb-4">
        <Button
          ...
          className="flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-orange-500 to-red-600 text-white font-semibold rounded-full shadow-lg hover:shadow-orange-200 hover:scale-105 transition-all duration-300 ease-in-out active:scale-95"
        >
        ...
        <input
          ...
          className="w-64 px-6 py-2 bg-white border-2 border-gray-200 rounded-full outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-100 transition-all placeholder:text-gray-400 shadow-sm"
        />
      </div>
      ...
      >
        ...
        <Modal.Body>
          ...
          {deleteMessage && (
            <p className="mt-4 text-center text-red-500">{deleteMessage}</p>
          )}
        </Modal.Body>
      </Modal>
    </div>
